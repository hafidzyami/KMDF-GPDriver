...
class CombinedMalwareDetector:
    ...
    def _identify_suspicious_clusters(self, data):
        ...
        # Dengan k=3, kita bisa lebih spesifik
        cluster_labels = []
